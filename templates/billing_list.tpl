   ...
   {include file="header.tpl"}
      ...
      <tr>
        ...
        <td colspan="5">  
         ...
         <option value="" selected="selected">--Pilih--</option>
                  ...
                  <option value="{$customer_name_opt[detail].id}" {$customer_name_opt[detail].selected}> 
                  {$customer_name_opt[detail].customer_name} </option>
                  {/section}
         </select> 
    ...
    {$btnprint}
     ...
     <table class="table table-stripped table-hover table-bordered">
        ...
        <td> {$list[detail].contract_date}  </td>
        <td> 
        ...
        <td align="center"> Rp.{$list[detail].totalpaid}  </td>
        <td align="center"> Rp.{$list[detail].totalbillamount}  </td>
        </tr>
        {/section}
        
        <tr align="center">  
        <td colspan="4"> <b> TOTAL </b> </td>
        <td> RP. {$sumtotalbill}  </td>
        <td> Rp. {$sumtotalpaid} </td>
        </tr>
