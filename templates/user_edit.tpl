      ...
      <div class="row">
        ...
        <input type="hidden" name="id" value="{$id}">
           ...
           <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="username" value="{$username}" required="required">
           ...
           <div class="form-group">
            ...
            <br>
             <div class="form-group">
            <p class="alert alert-danger" align="center"> <b>Kosongkan Field Password Bila Tidak Ingin Merubah Password  </b></p>
            </div>
            <br>
          ...
          <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" value="{$nama_pegawai}" name="nama_pegawai"  required="required">
              </div>
          ...
          <div class="form-group">
             ...
             <div class="col-sm-9">
                <select name="level_user" class="form-control">
                  ...
                  {section name = detail loop=$level_user_opt}
                  <option value="{$level_user_opt[detail].id}" {$level_user_opt[detail].selected}> {$level_user_opt[detail].level_user} </option>
                  {/section}
                </select>
              </div>
