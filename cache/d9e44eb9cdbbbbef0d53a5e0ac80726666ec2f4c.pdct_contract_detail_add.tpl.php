<?php
/*%%SmartyHeaderCode:3057556a8dbadc8c3c5_45359476%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd9e44eb9cdbbbbef0d53a5e0ac80726666ec2f4c' => 
    array (
  ...
  'nocache_hash' => '3057556a8dbadc8c3c5_45359476',
  'tpl_function' => 
  array (
  ),
  'version' => '3.1.24',
  'unifunc' => 'content_56a9672ec126b5_68685464',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56a9672ec126b5_68685464')) {
function content_56a9672ec126b5_68685464 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="row">
        <div class="col-md-6 small">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="cont_level" required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="acc_no" required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="sid" required>
              </div>
        ...
        <div class="col-md-6 small">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="starting" id="dp1"   required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="ending" id="dp2"  required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="number" class="form-control input-sm" name="masa_kontrak"  required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="acc_manager"  required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" id="otc" class="form-control input-sm" name="otc"  required>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" id="monthly" class="form-control input-sm" name="monthly"  required>
              </div>
      ...
      <div class="row">
        <div class="col-md-6 small">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="end_usera" required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="bill_period" required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text"  class="form-control input-sm" name="fpno" required>
              </div>
        ...
        <div class="col-md-6 small">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text"  class="form-control input-sm" name="bill" id="bill" required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-2">
              <label class="labeled">
              <input type="radio" name="statuspaid" value="N" class="form-control"> NO
              </label>
              </div>
