<?php
/*%%SmartyHeaderCode:1214056a956bad5e446_13902721%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e285772b4a3d6dbd38daa4b732463e1157dfdac4' => 
    array (
  ...
  'nocache_hash' => '1214056a956bad5e446_13902721',
  'tpl_function' => 
  array (
  ),
  'version' => '3.1.24',
  'unifunc' => 'content_56a97234bdf958_35143526',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56a97234bdf958_35143526')) {
function content_56a97234bdf958_35143526 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        &nbsp;
           <table id="example" class="table table-striped table-bordered table-hover" style="width:100%;">
              <thead style="background-color:#FFF;">
                ...
                <a href="master_pdct.php?idcust=1&act=DetailContract" title="Detail Kontrak"> <i class="glyphicon glyphicon-bookmark"> </i> </a>
                <a href="master_pdct.php?id=1&act=Update" title="Edit"> <i class="glyphicon glyphicon-pencil"> </i> </a>
                <a href="master_pdct.php?id=1&act=Delete" title="Hapus"> <i class="glyphicon glyphicon-trash"> </i> </a> 
                ...
                <td style="width:8%;" class="alert alert-info"> 
                <a href="master_pdct.php?idcust=10&act=DetailContract" title="Detail Kontrak"> <i class="glyphicon glyphicon-bookmark"> </i> </a>
                <a href="master_pdct.php?id=10&act=Update" title="Edit"> <i class="glyphicon glyphicon-pencil"> </i> </a>
                <a href="master_pdct.php?id=10&act=Delete" title="Hapus"> <i class="glyphicon glyphicon-trash"> </i> </a> 
                ...
                <td style="width:5%;" class="alert alert-info"> Administration </td>
                <td style="width:8%;" class="alert alert-info"> 
                <a href="master_pdct.php?idcust=11&act=DetailContract" title="Detail Kontrak"> <i class="glyphicon glyphicon-bookmark"> </i> </a>
                <a href="master_pdct.php?id=11&act=Update" title="Edit"> <i class="glyphicon glyphicon-pencil"> </i> </a>
                <a href="master_pdct.php?id=11&act=Delete" title="Hapus"> <i class="glyphicon glyphicon-trash"> </i> </a> 
