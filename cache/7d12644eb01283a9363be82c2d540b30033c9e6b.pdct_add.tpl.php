<?php
/*%%SmartyHeaderCode:3252056a74f11d183e4_47536373%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7d12644eb01283a9363be82c2d540b30033c9e6b' => 
    array (
  ...
  'nocache_hash' => '3252056a74f11d183e4_47536373',
  'tpl_function' => 
  array (
  ),
  'version' => '3.1.24',
  'unifunc' => 'content_56a972312b2ce2_74196064',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56a972312b2ce2_74196064')) {
function content_56a972312b2ce2_74196064 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="row">
        <div class="col-md-6 small">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" id="input_cust_name" class="form-control input-sm" name="cust_names" autocomplete="off" onkeyup="autoCompletea();" required="required">
              </div>

              <input type='hidden' id='idcust' name='cust_name'>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" id="input_pronumb" autocomplete="off" onkeyup="autoComplete();"  required="required">
              </div>

              <input type='hidden' id='idprono' name='pro_no'>
              <div style="margin-left:150px;">
              <div id="hasil"></div>
              </div>
            ...
            <br>
             ...
             <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="cc_name"  required="required">
              </div>
        ...
        <div class="col-md-6 small">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="site_name"  required="required">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="nama_pekerjaan"  required="required">
              </div>
