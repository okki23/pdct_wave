...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_56f0c50a0798a6_66029565',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56f0c50a0798a6_66029565')) {
function content_56f0c50a0798a6_66029565 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="row">
        <div class="col-md-6 small">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="cust_names" id="inputan_cust_name" class="form-control input-sm" autocomplete="off" onkeyup="autoComplete();" required="required" required="required" value="PT.SISINDOKOM">
              </div>

              <input type='hidden' id='idcust' name='id_cust_name' value='2'>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="project_no" value="PR001" required="required">
              </div>
        ...
        <div class="col-md-6 small">
                 ...
                 <label  class="col-sm-3 form-control-static"> CC Name </label>
                   ...
                   <div class="col-sm-9">
                     <input type="text" class="form-control input-sm" name="cc_name" value="CC201" >
                   </div>
            ...
            <br>
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="site_name" value="Kranji">
              </div>
