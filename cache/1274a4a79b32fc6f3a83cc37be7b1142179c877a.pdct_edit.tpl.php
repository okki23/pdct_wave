<?php
/*%%SmartyHeaderCode:3034056a8dbd6e7f488_69080492%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1274a4a79b32fc6f3a83cc37be7b1142179c877a' => 
    array (
  ...
  'nocache_hash' => '3034056a8dbd6e7f488_69080492',
  'tpl_function' => 
  array (
  ),
  'version' => '3.1.24',
  'unifunc' => 'content_56a97233bd4754_18202111',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56a97233bd4754_18202111')) {
function content_56a97233bd4754_18202111 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="row">
        <div class="col-md-6 small">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" id="input_cust_name" class="form-control input-sm" name="cust_names" autocomplete="off" onkeyup="autoCompletea();" value="PT.LANGIT ANGKASA PURA" required="required">
              </div>

              <input type='hidden' id='idcust' name='cust_name'  value="PT.LANGIT ANGKASA PURA">
           ...
           <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" id="input_pronumb" autocomplete="off" onkeyup="autoComplete();" value="P-0012-SPE-A0" required="required">
              </div>

              <input type='hidden' id='idprono' name='pro_no'  value="P-0012-SPE-A0">
              <div style="margin-left:150px;">
              <div id="hasil"></div>
              </div>
            ...
            <br>
             ...
             <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="cc_name" value="SM002" required="required">
              </div>
        ...
        <div class="col-md-6 small">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="site_name" value="Bekasi Timur" required="required">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="nama_pekerjaan" value="Grabbing Signal Wifi">
              </div>
            ...
            <br>
             ...
             <div class="form-group">
              <label  class="col-sm-3 form-control-static"> Status </label>
