...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_56e7c3af662324_79825000',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56e7c3af662324_79825000')) {
function content_56e7c3af662324_79825000 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<body>
 <!-- Fixed navbar -->
  ...
  <form name="print" method="POST" action="print_extention_project_list.php" target="_blank" enctype="multipart/form-data"> 
     ...
     <input type="hidden" name="start_date_send" value="1970-01-01">
     <input type="hidden" name="ending_date_send" value="1970-01-01">
