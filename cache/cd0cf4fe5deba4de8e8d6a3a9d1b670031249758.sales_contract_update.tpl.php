<?php
/*%%SmartyHeaderCode:1014256e77bacb377b1_22105613%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cd0cf4fe5deba4de8e8d6a3a9d1b670031249758' => 
    array (
      0 => './templates/sales_contract_update.tpl',
      1 => 1458011050,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1014256e77bacb377b1_22105613',
  'tpl_function' => 
  array (
  ),
  'version' => '3.1.24',
  'unifunc' => 'content_56e77bca92edc4_50418118',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56e77bca92edc4_50418118')) {
function content_56e77bca92edc4_50418118 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
  <head>
 ...
 <!-- Fixed navbar -->
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> guthi   <span class="caret"></span></a>
              <ul class="dropdown-menu">
  ...
  <div class="alert alert-info"> <h3 align="center">Ubah Data PDCT Contract </h3></div>
    ...
    <button onclick="history.go(-1);" class="btn btn-primary"> <i class="glyphicon glyphicon-arrow-left"> </i> Back </button>
     ...
     <form action="master_pdct.php?act=SalesContractUpdateAct" method="POST" enctype="multipart/form-data" name="myForm">
     <input type="hidden" name="id" value="36">
     <input type="hidden" name="idcust" value="11">
              ...
              <div class="col-sm-9">
                ...
                <select name="contract_status" class="form-control" style="border-color: red;">
                  <option value="" selected="selected">--Pilih--</option>
                                    ...
                                    <option value="2" selected=selected> On Service </option>
