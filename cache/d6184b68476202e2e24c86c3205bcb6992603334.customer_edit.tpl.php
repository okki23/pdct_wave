<?php
/*%%SmartyHeaderCode:2954156a972e2dcf3a5_53504363%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd6184b68476202e2e24c86c3205bcb6992603334' => 
    array (
      0 => './templates/customer_edit.tpl',
      1 => 1453945464,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2954156a972e2dcf3a5_53504363',
  'tpl_function' => 
  array (
  ),
  'version' => '3.1.24',
  'unifunc' => 'content_56a97303ce4671_77951149',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56a97303ce4671_77951149')) {
function content_56a97303ce4671_77951149 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#b     <form action="customer.php?act=ProAdd" method="POST" enctype="multipart/form-data" name="myForm">ill').mask('000.000.000.000.000', {reverse: true});
...
<body>
 <!-- Fixed navbar -->
    ...
    <div class="col-md-12">
     ...
     <br>
     <br>
          <form action="customer.php?act=ProUpdate" method="POST" enctype="multipart/form-data" name="myForm">
      ...
      <div class="row">
        ...
        <input type="hidden" name="id" value="4">
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" value="PT.FIRST MEDIA TBK" name="customer_name" required="required">
              </div>
