<?php
/*%%SmartyHeaderCode:42356a629d317e374_69921524%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd380ec65801ed44a6b3ac22a4e21f5bb391c86bf' => 
    array (
  ...
  'nocache_hash' => '42356a629d317e374_69921524',
  'tpl_function' => 
  array (
  ),
  'version' => '3.1.24',
  'unifunc' => 'content_56a9713de6c5a7_35242159',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56a9713de6c5a7_35242159')) {
function content_56a9713de6c5a7_35242159 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<body>
 <!-- Fixed navbar -->
    ...
    <div class="col-md-12">
     ...
     <form action="m_user.php?act=ProUpdate" method="POST" enctype="multipart/form-data" name="myForm">
      <div class="alert alert-info"> <h3 align="center">Update Data User </h3></div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 small">
           ...
           <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="username" required="required" value="">
              </div>
           ...
           <div class="form-group">
              ...
              <div class="col-lg-12">
              <div style="float:right; margin-right:20px; color:red;">
               <b>Jika Password Tidak Ingin Dirubah Harap Kosongkan Saja ! &nbsp; </b>  
              </div>
              </div>
              <br>
          ...
          <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="nama_user"  required="required" value="">
              </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="branch" value=""  required="required">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="alamat" value="" required="required">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="no_hp" value="" required="required">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="bbm" value="" required="required">
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="email" value="" required="required">
              </div>
 ...
 <div class="form-group">
              ...
              <div class="col-lg-12">
              <div style="float:right; margin-right:20px; color:red;">
               <b>Jika Foto Tidak Ingin Dirubah Harap Kosongkan Saja ! &nbsp; </b>  
              </div>
              </div>
              <br>
            ...
            <div class="form-group">
              ...
              <br>
              <div align="center">
              <img src="fotopegawai/" width="100" height="100">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control input-sm" name="nik" value="" required="required">
              </div>
