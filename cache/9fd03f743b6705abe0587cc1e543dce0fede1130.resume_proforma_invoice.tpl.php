...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_56e99c67cba9b8_32333126',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56e99c67cba9b8_32333126')) {
function content_56e99c67cba9b8_32333126 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
  <head>
 ...
 <!-- Fixed navbar -->
  ...
  <br>
   <form name="print" method="POST" action="print_resume_proforma_invoice_pdf.php" target="_blank" enctype="multipart/form-data">     
     ...
     <input type="hidden" name="bill_period" value="">
