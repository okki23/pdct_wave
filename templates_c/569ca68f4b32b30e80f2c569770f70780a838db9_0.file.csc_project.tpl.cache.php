<?php /* Smarty version 3.1.24, created on 2016-03-15 09:14:00
         compiled from "./templates/csc_project.tpl" */ ?>
<?php
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_56e7c448990e58_29539424',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56e7c448990e58_29539424')) {
function content_56e7c448990e58_29539424 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '492256e7c4488dd964_05551670';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
> <?php echo $_smarty_tpl->tpl_vars['customer_name_opt']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['customer_name'];?>
     ...
     <table class="table table-stripped table-hover" >
      ...
      <tr>  
          <td> <b>Month </b> </td>
          <td> : </td>
          <td> <?php echo $_smarty_tpl->tpl_vars['start_date_show']->value;?>
</td>
          <td> <b>To</b> </td>
          <td> <?php echo $_smarty_tpl->tpl_vars['ending_date_show']->value;?>
</td>
      </tr>
...
" target="_blank"><img src="images/logopdf.jpg" style="width:7%; height=:7%; "><?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['contract_number_file'];?>
        ...
        <td align="center"> 
        <?php ob_start();
echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['statuscscpaid'];
$_tmp3=ob_get_clean();
if ($_tmp3 == 'Y') {?>
        Sudah Bayar / PAID
        ...
        <td align="center"> Rp.<?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['totalcsc'];?>
  </td>
        </tr>
        <?php endfor; endif; ?>
