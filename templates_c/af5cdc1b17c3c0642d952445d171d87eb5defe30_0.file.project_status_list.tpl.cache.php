<?php /* Smarty version 3.1.24, created on 2016-03-15 09:03:17
         compiled from "./templates/project_status_list.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:2652956e7c1c59ba707_13770948%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af5cdc1b17c3c0642d952445d171d87eb5defe30' => 
    array (
      0 => './templates/project_status_list.tpl',
      1 => 1458028996,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2652956e7c1c59ba707_13770948',
  'variables' => 
  array (
    'title' => 0,
    'info' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_56e7c1c5a6c390_74876373',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56e7c1c5a6c390_74876373')) {
function content_56e7c1c5a6c390_74876373 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '2652956e7c1c59ba707_13770948';
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
?>
    ...
    <div style="margin-top:50px;">
        ...
        <h2>Project Status List PT Wave Communication Indonesia</h2>
        </div>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
     <table class="table table-stripped table-hover">
       ...
       <tr>
        <td>  Periode  </td>
        <td>  : </td>
        <td> <input type="text" name="start_date" id="dp1" class="form-control" placeholder="Periode Awal" required="required"> </td>
        <td align="center">  To </td>
        <td> <input type="text" name="ending_date" id="dp2" class="form-control" placeholder="Periode Akhir" required="required" > </td>
      </tr>
     ...
     <form name="print" method="POST" action="print_project_status_list.php" target="_blank" enctype="multipart/form-data"> 
...
" target="_blank"><img src="images/logopdf.jpg" style="width:7%; height=:7%; "><?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['contract_number_file'];?>
        ...
        <td> <?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['detail']['index']]['customer_name'];?>
  </td>
        ...
        <?php endfor; endif; ?>
         ...
         <tr>
          ...
          <td align="center"> <b>Rp. <?php echo $_smarty_tpl->tpl_vars['sumtotal']->value;?>
 </b></td>
        </tr>
     </table>
   </div>
